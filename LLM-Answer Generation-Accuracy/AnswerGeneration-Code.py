...
Write correct and efficient code to solve the following problem. Output only the code, with no explanations or comments.
...
def run_model(model_name, input_csv):
    ...
    out_csv = f"accuracy_Code_{model_name}.csv"
